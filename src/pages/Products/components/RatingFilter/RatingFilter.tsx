  ...
  return (
    <ul className='my-3'>
      {Array(5)
        ...
        .map((_, index) => (
          <li
            className={`py-2 pl-2 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-sm transition-colors ${
              queryConfig?.rate && parseInt(queryConfig?.rate) === 5 - index ? 'bg-gray-100 dark:bg-gray-800' : ''
            }`}
            key={index}
